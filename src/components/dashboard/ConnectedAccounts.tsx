...
export const ConnectedAccounts: React.FC<ConnectedAccountsProps> = ({ 
  ...
  const maxAccounts = userPlan === "free" ? 2 : 10;
  ...
  const handleConnectNew = () => {
    // TODO: Implement connect new account functionality
    ...
    return (
      <Card className="border-0 shadow-sm">
        <CardHeader className="border-b border-gray-200">
          ...
          <p className="text-sm text-gray-600">Manage your social media profiles</p>
        </CardHeader>
    ...
    <Card className="border-0 shadow-sm">
      ...
      <CardContent className="p-6 space-y-4">
        ...
        <div className="text-center pt-2">
          ...
          {userPlan === "free" && accounts.length >= maxAccounts && (
            <div className="mt-2">
              <Badge variant="outline" className="text-xs">
                Upgrade to Pro for more accounts
              </Badge>
            </div>
          )}
        </div>
